    ...
    public class RegistrarServicesTest
    {
        ...
        public void CreateRegistrantChange(long accountId, object domainId, string expectedUrl)
        {
            ...
            Assert.Multiple(() =>
            {
                ...
                Assert.That(check.CreatedAt, Is.EqualTo(Convert.ToDateTime("2017-02-03T17:43:22Z")));
                Assert.That(check.UpdatedAt, Is.EqualTo(Convert.ToDateTime("2017-02-03T17:43:22Z")));
